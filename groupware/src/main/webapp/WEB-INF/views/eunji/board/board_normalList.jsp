            	...
            	<div class="board_con">
					...
					<ul class="btn-group pagination">
					    <c:if test="${pageMaker.prev }">
						    <li>
						        <a class="line" href='<c:url value="/board_normal?page=${pageMaker.startPage-1}"/>'>prev</a>
						    </li>
					    </c:if>
					    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
						    <li>
						        <a class="line" href='<c:url value="/board_normal?page=${pageNum}"/>'>${pageNum}</a>
						    </li>
					    </c:forEach>
					    <c:if test="${pageMaker.next && pageMaker.endPage >0 }">
						    <li>
						        <a class="line" href='<c:url value="/board_normal?page=${pageMaker.endPage+1}"/>'>next</a>
						    </li>
					    </c:if>
					</ul>
